...
object JawaResolver {
   ...
   */
    ...
    if(!JawaCodeSource.isPreLoaded) throw new RuntimeException("In 'whole program' mode but library code has not been pre-loaded; call JawaCodeSource.preLoad first.")
